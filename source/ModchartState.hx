...
class ModchartState 
{
    ...
    public function new(script:String)
    {
				...
				var result = LuaL.dofile(lua, script); // execute le file
				...
				Lua_helper.add_callback(lua, "characterChangePsych", function(arg1:Dynamic, arg2:Dynamic) {
					var value1:String = arg1;
					var value2:String = arg2;
					PlayState.instance.changeCharacter(value1, value2);
